                      ...
                      <div className="offset-lg-1 col-lg-10 col-md-12 col-12">
                        <div className="d-lg-flex align-items-center justify-content-between">
                          ...
                          <div className="mb-4 mb-lg-0">
                            <h1 className="text-white mb-1">Ders Sonu Raporu Ekleyin</h1>
                            <p className="mb-0 text-white lead">
                              Alanları Doldurun ve Ders Sonu Raporunuzu Oluşturun
                            </p>
                          </div>
                          <div>
                            <Link
                  ...
                  <div className="card mb-3">
                    ...
                    <div className="card-body">
                      ...
                      <div className="mb-3">
                        ...
                        />
                        <small>En fazla 60 karakter olacak şekilde Ders Sonu Raporu başlığınızı yazın</small>
                      </div>
                      <div className="mb-3">
                        <label className="form-label">Ders Sonu Raporu Kategorisi</label>
                        <select
                      ...
                      <div className="mb-3">
                        ...
                        />
                        <small>
                        Ders Sonu Raporunun kısa bir özeti.</small>
                      </div>
                      {/* <label htmlFor="courseTitle" className="form-label">
                        Price
                      </label>
