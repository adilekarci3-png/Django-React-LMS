...
function EskepInstructorDersSonuRaporus() {
  ...
  const api = useAxios(); // Hook sadece burada çağrılır
  ...
  const fetchData = (userId) => {
    ...
    setFetching(true);
    api
      .get(`eskepinstructor/dersSonuRaporus-list/${userId}/`)
      .then((res) => {
          ...
          <div className="row mt-0 mt-md-4">
            ...
            <div className="col-lg-9 col-md-8 col-12">
              <h4 className="mb-4 d-flex align-items-center">
                <i className="fas fa-book-open text-success me-2"></i> Ders Sonu Raporlarım
              </h4>
              ...
              {fetching ? (
                ...
                <div className="card mb-4">
                  <div className="card-header">
                    <h3 className="mb-0">Raporlar</h3>
                    <span>Panel sayfanızdan raporları inceleyebilirsiniz.</span>
                  </div>
                  <div className="table-responsive overflow-y-hidden">
                    <table className="table mb-0 text-nowrap table-hover table-centered">
                      ...
                      <tbody>
                        {dersSonuRaporus.length > 0 ? (
                          dersSonuRaporus.map((c, index) => (
                            <tr key={index}>
                              <td>
