...
const StajerDuzenle = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await api.put(`/stajer/${id}/`, data, {
        headers: {
          "Content-Type": "multipart/form-data",
        },
      });
      navigate("/eskepinstructor/stajer-list/");
    } catch (err) {
            ...
            <div className="col-md-8 col-lg-9">
              <div className="card shadow-sm rounded p-4">
                <h3 className="mb-4 text-center">
                  🛠️ Stajyer Bilgilerini Güncelle
                </h3>
                <Formik
  ...
  try {
    await api.put(`/stajer/${id}/`, formDataToSend, {
      headers: {
        "Content-Type": "multipart/form-data",
      },
    });
