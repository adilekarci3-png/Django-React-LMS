...
function EskepInstructorCourseDetail() {
  ...
  const handleSaveQuestion = async (e) => {
    ...
    await api.post(`student/question-answer-list-create/${course.course?.id}/`, formdata).then((res) => {
      fetchCourseDetail();
      handleQuestionClose();
      Toast().fire({
        icon: "success",
  ...
  const sendNewMessage = async (e) => {
    ...
    api.post(`student/question-answer-message-create/`, formdata).then((res) => {
