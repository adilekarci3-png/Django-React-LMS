...
function DersSonuRaporuDetail() {
  ...
  const fetchDersSonuRaporuDetail = async () => {
    try {
      debugger;
  ...
  const handleMarkLessonAsCompleted = (variantItemId) => {
    ...
    useAxios()
      .post(`instructor/derssonuraporu-completed/`, formdata)
      .then((res) => {
        fetchDersSonuRaporuDetail();
        setMarkAsCompletedStatus({
          ...markAsCompletedStatus,
  ...
  const handleSaveQuestion = async (e) => {
    ...
    await useAxios()
      .post(
        `eskepinstructor/question-answer-list-create/${param.dersSonuRaporu_id}/`,
        formdata
      )
      .then((res) => {
        debugger;
  ...
  const handleCreateReviewSubmit = (e) => {
    ...
    useAxios()
      .post(`stajer/rate-derssonuraporu/`, formdata)
      .then((res) => {
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                ...
                                {dersSonuRaporu?.curriculum?.map((c, index) => (
                                  <div
                                            ...
                                            <div className="d-flex justify-content-between align-items-center">
                                              ...
                                              <div className="d-flex">
                                                ...
                                                <input
                                                  ...
                                                  checked={dersSonuRaporu.completed_lesson?.some(
                                                    (cl) =>
                                                      cl.variant_item.id ===
                                                      l.id
                                                  )}
                            ...
                            >
                              <div className="card">
                                ...
                                <div className="card-body p-0 pt-3">
                                  {/* Note item start */}
                                  {dersSonuRaporu?.notes?.map((n, index) => (
