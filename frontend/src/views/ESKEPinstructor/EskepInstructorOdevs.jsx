...
function EskepInstructorOdevs() {
  ...
  const api = useAxios(); // useAxios hook'u bir değişkende sakla
  const userData = useUserData(); // bu hook da burada en üstte çağrılmalı
  ...
  useEffect(() => {
    if (userData?.user_id) {
      fetchData(userData.user_id); // burada user_id parametre olarak verilir
    }
  }, [userData]);
        ...
        <div className="container">
          ...
          <div className="row mt-0 mt-md-4">
            ...
            <div className="col-lg-9 col-md-8 col-12">
              <h4 className="mb-4">
                <i className="fas fa-chalkboard-user text-primary me-2"></i> Gönderilen Ödevler
              </h4>
