...
function KitapTahliliDetail() {
  ...
  const refreshConversation = async (questionId) => {
    try {
      ...
      // Kitap tahlili için kendi endpoint'i:
      const res = await api.get(
                      ...
                      <div className="card shadow rounded-2 p-0 mt-n5">
                        ...
                        <div className="card-body p-sm-4">
                          <div className="tab-content">
                            {/* Bölümler */}
                            <div className="tab-pane fade show active" id="kt-tabs-1">
                              <div className="accordion modern-accordion" id="accordionExample2">
                                    ...
                                    >
                                      <div className="accordion-body">
                                        {(c?.variant_items || []).map((l, idx) => {
                                          ...
                                          return (
                                            <div key={idx} className="lesson-item d-flex justify-content-between">
                                              <div>
                                                <strong>{l?.title || `Ders ${idx + 1}`}</strong>
                                                <br />
                                                {l?.file ? (
                                              ...
                                              <div className="lesson-info d-flex align-items-center gap-2">
                                                <span className="text-muted">{l?.content_duration || "0m 0s"}</span>
                                                <input
                                                  type="checkbox"
                            ...
                            {/* Notlar */}
                            <div className="tab-pane fade" id="kt-tabs-2">
                              <div className="card">
                            ...
                            {/* Konuşma */}
                            <div className="tab-pane fade" id="kt-tabs-3">
                              <div className="card">
                                        ...
                                        <div className="d-sm-flex justify-content-sm-between mb-3">
                                          <div className="d-flex align-items-center">
                                            ...
                                            <div className="ms-2">
                                              ...
                                              <small>{q?.date ? moment(q.date).format("DD MMM, YYYY") : ""}</small>
                                            </div>
                                          </div>
                                        </div>
                                        <h5>{q?.title}</h5>
                            ...
                            {/* Not Ver */}
                            <div className="tab-pane fade" id="kt-tabs-4">
                              <div className="card">
                                <div className="card-header border-bottom p-0 pb-3">
                            ...
                            <div className="me-2">
                              <h6 className="mb-1 lead fw-bold">
                                ...
                                <span style={{ fontSize: 12, color: "gray" }}>
                                  {m?.date ? moment(m.date).format("DD MMM, YYYY") : ""}
                                </span>
                              </h6>
