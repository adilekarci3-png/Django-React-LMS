      ...
      <nav className="navbar navbar-expand-lg" aria-label="HBS üst menü">
        <div className="container-xl px-3 px-lg-4">
          ...
          <Link className="navbar-brand fw-bold text-white d-flex align-items-center gap-2" to="/">
            ...
            <span>HBS</span>
            <span className="d-none d-sm-inline text-white-50 small">Hafızlar Bilgi Sistemi</span>
          </Link>
          ...
          <div className="collapse navbar-collapse" id="hbsNav">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0 align-items-lg-center gap-lg-1">
              ...
              {isLoggedIn?.() && hasSubRole("HBSTemsilci") ? (
                ...
                <li className="nav-item">
                  <NavLink className="nav-link hdm-link hbs-chip-link" to="/hafizbilgi/create-hafizbilgi/">
            ...
            <div className="d-none d-lg-flex align-items-center">
              <div className="hbs-search-pill me-2">
                ...
                />
                <button className="btn btn-light btn-sm rounded-pill" onClick={handleSearch}>
                  Ara
                </button>
              </div>
              ...
              {isLoggedIn?.() ? (
                <>
                  <Link to="/profile" className="btn btn-outline-light btn-sm rounded-pill me-2">
                    Profil
                  </Link>
