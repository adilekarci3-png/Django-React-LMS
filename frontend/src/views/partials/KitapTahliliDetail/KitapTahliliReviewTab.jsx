...
function KitapTahliliReviewTab({ kitaptahlili, studentReview, fetchKitapTahliliDetail }) {
  ...
  const handleCreateReviewSubmit = async (e) => {
    ...
    try {
      await useAxios().post(`eskepstajer/rate-kitaptahlili/`, formData);
...
export default KitapTahliliReviewTab;
