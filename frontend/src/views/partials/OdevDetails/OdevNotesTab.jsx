...
function OdevNotesTab({ odev, fetchOdevDetail, id }) {
    ...
    const handleCreateSubmit = async (e) => {
        ...
        formData.append("odev_id", id);
        formData.append("title", createNote.title);
        formData.append("note", createNote.note);

        try {
            await useAxios().post(`eskepstajer/odev-note/${user?.user_id}/${id}/`, formData);
            console.log("✅ Not eklendi, fetchOdevDetail çağrılıyor");
            await fetchOdevDetail(); // await önemli olabilir
            Swal.fire({
                icon: "success",
                title: "Başarılı!",
    ...
    const handleEditSubmit = async (e) => {
        ...
        try {
            await useAxios().patch(
                `eskepstajer/odev-note-detail/${user?.user_id}/${id}/${selectedNote.id}/`,
                formData
            );
            fetchOdevDetail();
            Swal.fire({
    ...
    const handleDelete = async (selectedNoteid) => {
        try {
            await useAxios().delete(
                `eskepstajer/odev-note-detail/${user?.user_id}/${id}/${selectedNoteid}/`
            );
            fetchOdevDetail();
            Swal.fire({
                icon: "success",
