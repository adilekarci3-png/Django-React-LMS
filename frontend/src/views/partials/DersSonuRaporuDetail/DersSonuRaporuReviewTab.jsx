...
function DersSonuRaporuReviewTab({ derssonuraporu, studentReview, fetchDersSonuRaporuDetail }) {
  ...
  const handleCreateReviewSubmit = async (e) => {
    ...
    try {
      await useAxios().post(`eskepstajer/rate-derssonuraporu/`, formData);
...
export default DersSonuRaporuReviewTab;
