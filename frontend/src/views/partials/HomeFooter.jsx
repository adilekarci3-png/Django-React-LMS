    ...
    <footer className="footer-wrap text-light mt-5">
      <div className="container py-5">
        <div className="row g-4">
          <div className="col-md-4">
            <h4 className="text-white mb-3">Eğitim Portalı</h4>
          ...
          <div className="col-6 col-md-3">
            ...
            <p className="text-footer mt-2 mb-1">E-posta: <a href="mailto:bilgi@ehad.org.tr" className="footer-link">bilgi@egitimportali.com</a></p>
      ...
      <div className="footer-bottom py-3">
        <div className="container d-flex flex-column flex-md-row align-items-center justify-content-between gap-2">
          <small className="text-footer">&copy; {new Date().getFullYear()} Eğitim Portalı. Tüm hakları saklıdır.</small>
