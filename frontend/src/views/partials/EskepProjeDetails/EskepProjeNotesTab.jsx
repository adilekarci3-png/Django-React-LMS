...
function EskepProjeNotesTab({ proje, fetchEskepProjeDetail, id }) {
    ...
    const handleCreateSubmit = async (e) => {
        ...
        formData.append("proje_id", id);
        formData.append("title", createNote.title);
        formData.append("note", createNote.note);

        try {
            await useAxios().post(`eskepstajer/proje-note/${user?.user_id}/${id}/`, formData);
            console.log("✅ Not eklendi, fetchEskepProjeDetail çağrılıyor");
            await fetchEskepProjeDetail(); // await önemli olabilir
            Swal.fire({
                icon: "success",
                title: "Başarılı!",
    ...
    const handleEditSubmit = async (e) => {
        ...
        try {
            await useAxios().patch(
                `eskepstajer/proje-note-detail/${user?.user_id}/${id}/${selectedNote.id}/`,
                formData
            );
    ...
    const handleDelete = async (selectedNoteid) => {
        try {
            await useAxios().delete(
                `eskepstajer/proje-note-detail/${user?.user_id}/${id}/${selectedNoteid}/`
            );
            fetchEskepProjeDetail();
            Swal.fire({
                icon: "success",
...
export default EskepProjeNotesTab;
