...
function ProjeCreate() {
  ...
  const validateForm = () => {
    ...
    if (!ckEdtitorData) newErrors.description = "Proje açıklaması zorunludur.";
          ...
          <div className="row mt-0 mt-md-4">
            ...
            <form className="col-lg-9 col-md-8 col-12" onSubmit={handleSubmit}>
              <div className="mb-3">
                ...
                <input type="text" className="form-control" name="title" onChange={handleProjeInputChange} />
              ...
              <div className="mb-3">
                ...
                <select className="form-select" name="category" onChange={handleProjeInputChange}>
                  <option value="">-------------</option>
              ...
              <button className="btn btn-success w-100" type="submit">Proje Oluştur</button>
            </form>
          </div>
        </div>
      </section>
