...
function EskepStajerOdevs() {
  ...
  useEffect(() => {
    ...
    if (statusFilter !== "all") {
      data = data.filter((r) => (r.odev_status || "") === statusFilter);
    }
    if (koorFilter !== "all") {
          ...
          <div className="row mt-0 mt-md-4">
            ...
            <div className="col-lg-9 col-md-9 col-12">
              <div className="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
                <h4 className="mb-0">
                  <i className="fas fa-chalkboard-user text-success me-2" />
                  Ödevlerim
                </h4>
                  ...
                  <div className="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <div>
                      ...
                      <span className="text-muted">
                        Staj sürecindeki ödev çalışmalarınızı buradan takip edebilirsiniz.
                      </span>
                    </div>
                      ...
                      {!fetching &&
                        ...
                        pageData.map((c) => (
                          <tr key={c.id}>
                            ...
                            <td data-label="Durum">
                              <span className={statusBadge(c.odev_status)}>
                                {c.odev_status || "—"}
                              </span>
                            </td>
