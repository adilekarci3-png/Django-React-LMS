...
class CartAPIView(generics.CreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        if cart:
            ...
            return Response({"message": "Sepet Başarılı Bir Şekilde Güncellendi"}, status=status.HTTP_200_OK)
            ...
            return Response({"message": "Sepet Başarılı Bir Şekilde Oluşturuldu"}, status=status.HTTP_201_CREATED)
...
class CreateOrderAPIView(generics.CreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        return Response({"message": "Ders Kaydı Başarılı Bir Şekilde Yapıldı", "order_oid": order.oid}, status=status.HTTP_201_CREATED)
