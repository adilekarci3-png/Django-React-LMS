...
PROJECT_DIR = Path(__file__).resolve().parent          # ...\Django React LMS\backend
# -------------------------------------------------
# CORE / SECURITY
# -------------------------------------------------
...
# -------------------------------------------------
STATIC_URL = "/static/"
STATICFILES_DIRS = [BASE_DIR / "static"]        # => ...\backend\static  ✅
...
MAILGUN_SECRET_KEY = env("MAILGUN_SECRET_KEY", default=None)
MAILERSEND_API_TOKEN = env("MAILERSEND_API_TOKEN", default=None)
MAILGUN_SENDER_DOMAIN = env("MAILGUN_SENDER_DOMAIN", default=None)

FRONTEND_SITE_URL = env("FRONTEND_SITE_URL", default=None)
